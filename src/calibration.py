...
def calc_discrete_entropy(cm_x, cm_y, max_distance, parameter_tup, im):
    ...
    # Use Gaussian kernel to smooth the histogram
...
def find_parameters(cm_x, cm_y, max_distance, im):
    ...
    image's center of mass and the distance from the image's farthest vertex
    to center of mass
    """
    ...
    # set up an explored set to optimize running time
    explored = set()
...
def save_parameters_to_file(a, b, c, filename):
    """
    Save the parameters a, b, c to a txt file
    """
...
output_filename = "parameters1.txt"
save_parameters_to_file(a, b, c, output_filename)
